...
class _RetoPageState extends State<RetoPage> {
  ...
  initGame() {
    ...
    score = 0;
    items = [
      ItemModel(name: "Tonatiuh", value: "Tonatiuh", address: "🌞"),
      ItemModel(name: "Xiuhcóatl", value: "Xiuhcóatl", address: "🐉"),
      ItemModel(name: "Metztli", value: "Metztli", address: "🌝"),
      ItemModel(name: "Conetl", value: "Conetl", address: "👲"),
      ItemModel(name: "Colli", value: "Colli", address: "👴"),
      ItemModel(name: "Cahuayo", value: "Cahuayo", address: "🐴"),
      ItemModel(name: "Lalax", value: "Lalax", address: "🍊"),
      ItemModel(name: "Nanacatl", value: "Nanacatl", address: "🍄"),
    ];
